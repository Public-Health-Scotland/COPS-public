...
saveRDS(cohort7_contemp, paste0(folder_results, "pre20weeks_hypertension.rds"))
saveRDS(cohort8_contemp, paste0(folder_results, "pre20weeks_vte.rds"))
saveRDS(cohort9_contemp, paste0(folder_results, "pre20weeks_bleeding.rds"))
saveRDS(cohort10_contemp, paste0(folder_results, "pre20weeks_icu.rds"))

# save model output for forest plot

saveRDS(model1, paste0(folder_results, "models/subgroup_analysis_pre20weeks_hypertension_unadjusted.rds"))
saveRDS(model1a, paste0(folder_results, "models/subgroup_analysis_pre20weeks_hypertension_adjusted.rds"))

saveRDS(model4, paste0(folder_results, "models/subgroup_analysis_pre20weeks_vte_unadjusted.rds"))
saveRDS(model4a, paste0(folder_results, "models/subgroup_analysis_pre20weeks_vte_adjusted.rds"))

saveRDS(model5, paste0(folder_results, "models/subgroup_analysis_pre20weeks_bleeding_unadjusted.rds"))
saveRDS(model5a, paste0(folder_results, "models/subgroup_analysis_pre20weeks_bleeding_adjusted.rds"))

saveRDS(model8, paste0(folder_results, "models/subgroup_analysis_pre20weeks_icu_unadjusted.rds"))
saveRDS(model8a, paste0(folder_results, "models/subgroup_analysis_pre20weeks_icu_adjusted.rds"))
