...
all_filters <- bind_rows(smr01_filters, smr02_filters, aas_filters, gp_losses_filters, an_booking_filters) %>% 
...
rm(smr01_filters, smr02_filters, aas_filters, gp_losses_filters, an_booking_filters, all_filters)

# numbers recoded
smr02_recoded <- read_rds(paste0(folder_temp_data, "smr02_recoded.rds"))
qcovid_recoded <- read_rds(paste0(folder_temp_data, "qcovid_recoded2.rds"))
