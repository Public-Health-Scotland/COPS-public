...
# Insert chart presenting number of COVID-19 vaccines given in pregnancy by
# dose, Scotland into the Microsoft Word document and save out
chart <- readRDS(params$path_chart)

tmp_word %>%
  officer::cursor_reach(keyword = "Figure x") %>%
